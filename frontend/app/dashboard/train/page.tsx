  ...
  useEffect(() => {
    if (activeSection === 0) {
      ...
      if (img) {
        ...
        img.onerror = () => {
          setError(
            "Failed to connect to video feed. Please ensure the Python server is running."
          );
          setIsLoading(false);
        };
          ...
          <div className="grid grid-cols-1 gap-6">
            <div className="bg-gray-900 rounded-lg shadow-xl p-6 border border-gray-800">
              ...
              <div className="mt-4">
                <p className="text-gray-400 text-sm">
                  Compare your posture with the reference image. The AI will
                  analyze your posture in real-time and highlight areas that
                  need adjustment in red.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-900 rounded-lg shadow-xl p-6 border border-gray-800">
              ...
              <Accordion type="single" collapsible className="w-full">
                ...
                >
                  ...
                  <AccordionContent className="px-4 py-3 text-gray-400">
                    <ul className="list-disc pl-5 space-y-2">
                      ...
                      <li>
                        Avoid hunching forward or raising your shoulders toward
                        your ears
                      </li>
                      <li>Maintain equal height for both shoulders</li>
                      <li>
                        Your shoulders should form a straight line when viewed
                        from the front
                      </li>
                ...
                >
                  ...
                  <AccordionContent className="px-4 py-3 text-gray-400">
                    <ul className="list-disc pl-5 space-y-2">
                      ...
                      <li>
                        Avoid tilting your head down (appears disengaged) or up
                        (appears arrogant)
                      </li>
                ...
                >
                  ...
                  <AccordionContent className="px-4 py-3 text-gray-400">
                    <ul className="list-disc pl-5 space-y-2">
                      <li>
                        Rest hands comfortably on the table or in your lap
                      </li>
                      ...
                      <li>
                        Moderate hand gestures can emphasize points, but don't
                        overdo it
                      </li>
                    </ul>
                  </AccordionContent>
                ...
                >
                  ...
                  <AccordionContent className="px-4 py-3 text-gray-400">
                    <ul className="list-disc pl-5 space-y-2">
                      ...
                      <li>
                        Avoid slouching or leaning too far back (appears too
                        casual)
                      </li>
                    </ul>
                  </AccordionContent>
              ...
              <div className="mt-6 p-4 bg-blue-900/30 rounded-lg border border-blue-800">
                ...
                <ul className="text-gray-300 space-y-1 text-sm">
                  <li>
                    • Practice your posture in front of a mirror regularly
                  </li>
                  <li>
                    • Record yourself in mock interviews to identify issues
                  </li>
                  <li>
                    • Good posture not only looks better but helps you breathe
                    properly and reduces anxiety
                  </li>
                  <li>
                    • Remember that proper posture helps you appear confident
            ...
            <div className="bg-gray-900 rounded-lg shadow-xl p-6 border border-gray-800 mt-8">
              ...
              <p className="text-gray-300 mb-4">
                Research shows that interviewers form 60% of their impression
                within the first 15 seconds of meeting you. Your posture
                communicates confidence, professionalism, and attention to
                detail before you even begin speaking.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                <div className="bg-gray-800 p-4 rounded-lg">
                  ...
                  <p className="text-gray-400 text-sm">
                    Good posture actually changes your hormone levels,
                    increasing testosterone and decreasing cortisol, helping you
                ...
                <div className="bg-gray-800 p-4 rounded-lg">
                  ...
                  <p className="text-gray-400 text-sm">
                    Interviewers associate upright posture with leadership
                    qualities, attention to detail, and higher competence
                    levels.
                  </p>
                </div>
                <div className="bg-gray-800 p-4 rounded-lg">
                  ...
                  <p className="text-gray-400 text-sm">
                    Proper posture improves breathing, reduces fatigue, and
                    helps you think more clearly during challenging interview
                    questions.
                  </p>
                </div>
              </div>
